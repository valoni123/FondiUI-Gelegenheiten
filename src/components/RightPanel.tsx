    ...
    <div className="flex h-full flex-col p-4 overflow-hidden">
      ...
      <Card className="flex-grow flex flex-col min-h-0">
        <CardContent className="p-6 flex flex-1 flex-col min-h-0 overflow-y-auto overflow-x-hidden">
          ...
          {/* Dokumentenliste: passt sich an Inhalt an, wächst bei Bedarf bis max. 50vh (danach interner Scroll) */}
          ...
          {/* Dokumentenvorschau: keine eigene Scrollbar, nimmt die benötigte Höhe ein */}
